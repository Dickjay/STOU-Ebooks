...
public class ImageViewTouchBase_Crop extends ImageView implements IDisposable {
	...
	public ImageViewTouchBase_Crop(Context context)
	{
		super(context);
		init();
	}

	public ImageViewTouchBase_Crop(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}
	...
	{
		Log.d(LOG_TAG, "setImageRotateBitmap_CropReset");
		...
		// if (UriResultImageCrop.getMatrix() != null) {
		// setImageMatrix(Command.Reset, UriResultImageCrop.getMatrix());
		// } else {
	...
	{
		if (UriResultImageCrop.getMatrix1() != null && UriResultImageCrop.getMatrix2() != null) {
			mBaseMatrix = UriResultImageCrop.getMatrix1();
			mSuppMatrix = UriResultImageCrop.getMatrix2();
		}
