...
public abstract class BaseXMLParser {
	...
	public void initParser() {
		...
		try {
			...
			//Log.e(stringer.newBuilder().append(TAG).append("#parse").toString(),"ParserConfigurationException");
			e.printStackTrace();
		} catch (SAXException e) {
			//Log.e(stringer.newBuilder().append(TAG).append("#parse").toString(),"SAXException");
			e.printStackTrace();
		}
	}
	...
	public void parse(String xml) throws IllegalStateException {
		try {
			...
			//Log.e(stringer.newBuilder().append(TAG).append("#parse").toString(),"IOException");
			e.printStackTrace();
		}

		//Log.v(stringer.newBuilder().append(TAG).append("#parse").toString(),"done parsing xml");
	}
