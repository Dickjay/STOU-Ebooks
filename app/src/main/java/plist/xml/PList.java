...
import plist.type.Data;
import plist.type.Date;
import plist.type.Dict;
import plist.type.False;
import plist.type.Integer;
import plist.type.Real;
import plist.type.String;
import plist.type.True;
...
public class PList implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3913977761295593990L;
	...
	private final Stack<PListObject> stack;
