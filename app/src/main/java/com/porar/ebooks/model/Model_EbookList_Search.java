...
public class Model_EbookList_Search implements Comparable<Model_EbookList_Search> {
	...
	public Model_EbookList_Search(PListObject plistObject) {
	...
	@Override
	public int compareTo(Model_EbookList_Search another) {
