 ...
 */
public class Fragment_ThrashEbooks extends Fragment implements OnStartDragListener, FlexibleDividerDecoration.VisibilityProvider {
    public static Handler handler = new Handler();
    public static Model_EBook_Shelf_List model_ebook_shelf_list;
    public ArrayList<Model_EBook_Shelf_List> array_ebook_shelf_list;
    ...
    public static Fragment newInstance() {
        Fragment_ThrashEbooks fragment_thrashEbooks = new Fragment_ThrashEbooks();
        return fragment_thrashEbooks;
    }
    ...
    public void setListAdapterAllBook(ArrayList<Model_EBook_Shelf_List> array_ebook_shelf_list) {
        ...
        adapter_recyclerView_bookShelf = new Adapter_RecyclerView_BookShelf(getActivity(), array_ebook_shelf_list, this, Fragment_ThrashEbooks.this) {
            @Override
            public void OnClickCover(Model_EBook_Shelf_List model) {
                ...
                Fragment_ThrashEbooks.this.startActivityForResult(myIntent, 2013);
            ...
            public void getAllItem(ArrayList<Model_EBook_Shelf_List> m_array_ebook_shelf_list) {
                int allItem = getItemCount();
                for (int pos = 0; pos < allItem; pos++) {
                    String currentItem = m_array_ebook_shelf_list.get(pos).getBID() + "";
                    Log.e("Fragment_AllEbooks", "Current Book " + currentItem);
                }
            }
