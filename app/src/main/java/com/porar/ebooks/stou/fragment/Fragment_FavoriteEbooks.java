 ...
 */
public class Fragment_FavoriteEbooks extends Fragment implements OnStartDragListener, FlexibleDividerDecoration.VisibilityProvider {
    public static Fragment_FavoriteEbooks fragment_favoriteEbooks;
    ...
    public static Fragment newInstance() {
        fragment_favoriteEbooks = new Fragment_FavoriteEbooks();
        return fragment_favoriteEbooks;
    }
    ...
    public void setListAdapterAllBook(ArrayList<Model_EBook_Shelf_List> array_ebook_shelf_list) {
        ...
        adapter_recyclerView_bookShelf = new Adapter_RecyclerView_BookShelf(getActivity(), array_ebook_shelf_list, this, Fragment_FavoriteEbooks.this) {
            @Override
            public void OnClickCover(Model_EBook_Shelf_List model) {
                ...
                Fragment_FavoriteEbooks.this.startActivityForResult(myIntent, 2013);
            ...
            public void getAllItem(ArrayList<Model_EBook_Shelf_List> m_array_ebook_shelf_list) {
                array_sort_ebooksID = new ArrayList<String>();
