...
public abstract class View_SearchEbookShelf {
...
//	private ListView lv_search;
	...
	public View_SearchEbookShelf(Activity context, LinearLayout linear_fotTypeEbook, RelativeLayout rt_dummyscreen, int id_head, String searchEditTextSaveInstance) {
		this.context = context;
		this.linear_fotTypeEbook = linear_fotTypeEbook;
		this.rt_dummyscreen = rt_dummyscreen;
		this.id_head = id_head;
		lastEdittext = searchEditTextSaveInstance;
	...
	public void initView(int left, int top, int height) {
		...
		layout_search = (LinearLayout) inflater.from(context).inflate(R.layout.layout_search_bookshelf, null);
