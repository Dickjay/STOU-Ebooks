...
public class MyLinear_CommentView extends LinearLayout {
	...
	public MyLinear_CommentView(Context context, Model_Comment_List comment_List) {
		super(context);
		init(comment_List);
	}
	...
	private void init(Model_Comment_List comment_List) {
		...
		layoutview = (LinearLayout) inLayoutInflater.inflate(R.layout.comments_list, null);
