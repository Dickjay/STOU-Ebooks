...
public class DialogLogin_Show extends Dialog {
    ...
    DialogLogin_Show dialog_ShowLargeImage;
    ...
    public DialogLogin_Show(Context context, int theme, Fragment fragment) {
        super(context, theme);
    ...
    public DialogLogin_Show(Context context, int theme, Activity activity) {
        super(context, theme);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        getWindow().getAttributes().windowAnimations = R.style.PauseDialogAnimation;
        dialog_ShowLargeImage = this;
