...
import com.porar.ebook.control.MyLinear_CommentView_Shelf;
import com.porar.ebooks.model.Model_Comment_List;
import com.porar.ebooks.stou.R;
import com.porar.ebooks.utils.StaticUtils;
import com.porar.ebooks.utils.StaticUtils.Font;

public class MyAdapterViewPager_Comment_Shelf extends PagerAdapter {
	...
	public MyAdapterViewPager_Comment_Shelf(Activity context,ArrayList<Model_Comment_List> comment_List) {
		...
		context.runOnUiThread(new Runnable() {
			...
			public void run() {
				if (sizePage == 0) {
					...
					// do View
					myView = new MyLinear_CommentView_Shelf(context, comment_List.get(position));
					((ViewPager) view).addView(myView);
				}
