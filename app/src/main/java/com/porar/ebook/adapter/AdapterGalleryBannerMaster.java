...
public class AdapterGalleryBannerMaster extends BaseAdapter implements
		Serializable {
	...
	Activity context;
	ArrayList<Model_Banner_Master> banners;
	ImageDownloader_forCache imageDownloader;
	LayoutInflater inflater;
	Handler handler = new Handler();

	public AdapterGalleryBannerMaster(Activity context,
			ArrayList<Model_Banner_Master> banners) {
